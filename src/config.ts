export const siteConfig = {
  ...
  projects: [
    ...
    {
      name: "机器学习平台优化：加速算法迭代（美团金融）",
      description:
        "面向“算法迭代强依赖业务工程发版、优化周期长”的问题，参与一站式机器学习平台能力优化，重点完善流量录制与流量回放功能，支持线上真实流量复用验证、定时录制与回放记录追踪。落地后显著提升算法验证效率，推动策略迭代周期由天级缩短至小时级。",
      skills: ["平台能力建设", "流量录制回放", "算法迭代提效", "策略验证"],
    },
  ],
  vibeCoding: [
    {
